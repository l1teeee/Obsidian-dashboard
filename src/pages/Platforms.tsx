              ...
              <div>
                {fbConnections.length > 1 && (
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-white leading-none">Facebook Pages</h3>
                      <p className="text-[10px] text-[#988d9c] mt-0.5">{fbConnections.length} pages connected</p>
                    </div>
              ...
              <div>
                {igConnections.length > 1 && (
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-white leading-none">Instagram Accounts</h3>
                      <p className="text-[10px] text-[#988d9c] mt-0.5">{igConnections.length} accounts connected</p>
                    </div>
