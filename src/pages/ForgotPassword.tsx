    ...
    >
      ...
      <div className="relative w-full max-w-[440px] overflow-hidden rounded-[2rem] border border-[#494847]/20 bg-[#1a1919]/70 p-10 shadow-[0_30px_120px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
        ...
        <div data-fp-anim className="mb-8 space-y-2">
          <p className="text-[0.6875rem] font-semibold uppercase tracking-[0.24em] text-[#d394ff]/70">Password reset</p>
          <h1 className="font-headline text-2xl font-bold tracking-tight text-[#e5e2e1]">Forgot your password?</h1>
          <p className="text-sm text-[#adaaaa]/50">
            Enter your email and we'll send you a reset code.
            {' '}<span className="text-[#adaaaa]/35">Google sign-in users can use this to set a password too.</span>
          </p>
        </div>
        ...
        <p data-fp-anim className="mt-6 text-center text-[0.8125rem] text-[#adaaaa]/50">
          Remember your password?{' '}
          <Link to="/login" className="font-semibold text-[#d394ff] transition-colors duration-300 hover:text-[#ebd6ff]">
            Sign in
          </Link>
        </p>
      </div>
