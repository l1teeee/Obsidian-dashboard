...
export function SpiralLoader({ size = 16, className }: SpiralLoaderProps) {
  ...
  return (
    <div className={cn("relative shrink-0", className)} style={{ width: size, height: size }}>
      <div className={cn("absolute inset-0 transition-opacity duration-75", phase === "fast" ? "opacity-100" : "opacity-0")}>
        <Lottie
          lottieRef={fastRef}
      ...
      <div className={cn("absolute inset-0 transition-opacity duration-75", phase === "slow" ? "opacity-100" : "opacity-0")}>
        <Lottie
          lottieRef={slowRef}
