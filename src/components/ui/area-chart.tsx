...
function DateTicker({ currentIndex, labels, visible }: { currentIndex: number; labels: string[]; visible: boolean }) {
  ...
  return (
    <motion.div className="overflow-hidden rounded-full bg-zinc-900 px-4 py-1 text-[#0F172A] shadow-lg dark:bg-zinc-100 dark:text-zinc-900" layout transition={{ layout: { type: "spring", stiffness: 400, damping: 35 } }}>
