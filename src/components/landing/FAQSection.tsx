...
export default function FAQSection() {
  ...
  return (
    <section ref={sectionRef} id="FAQ" className="relative overflow-hidden py-28 md:py-36">
      <div className="pointer-events-none absolute left-1/2 top-1/4 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-[#111827]/4 blur-[120px]" />
      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-12">
        <div className="mx-auto max-w-[780px]">
          ...
          <div className="mb-12 text-center">
            <span data-faq="eyebrow" style={{ opacity: 0 }} className="mb-5 inline-flex items-center gap-2 rounded-full border border-[rgba(15,23,42,0.14)] bg-[#FFFFFF] px-4 py-1.5 text-[0.68rem] font-bold uppercase tracking-[0.22em] text-[#64748B]">
              <span className="h-1.5 w-1.5 rounded-full bg-[#111827]" />
              FAQ
            </span>
            <h2 data-faq="title" style={{ opacity: 0 }} className="mt-5 text-4xl font-extrabold tracking-[-0.04em] leading-[0.96] text-[#0F172A] md:text-5xl">
              Quick answers.
            </h2>
            <p data-faq="sub" style={{ opacity: 0 }} className="mt-4 text-[1rem] font-light leading-[1.8] text-[#0F172A]/50">
              The questions we get asked most before signing up.
            </p>
          </div>

          {/* Accordion — 4 questions */}
          <div data-faq="list" style={{ opacity: 0 }} className="rounded-[1.75rem] border border-[rgba(15,23,42,0.14)] bg-[#FFFFFF] px-8">
          ...
          <div data-faq="cta" style={{ opacity: 0 }} className="mt-8 text-center">
            <button
              ...
              className="group inline-flex items-center gap-2 text-[0.875rem] font-semibold text-[#0F172A]/35 transition-all duration-300 hover:text-[#0F172A]/70"
            >
