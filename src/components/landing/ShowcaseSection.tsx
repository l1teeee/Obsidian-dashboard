          ...
          <div className="flex h-[100px] items-end gap-1.5">
            {bars.map((h, i) => (
              <div key={i} className="flex flex-1 flex-col justify-end">
                <div
                  className="rounded-t-[4px] border-t border-[#7DD3C7]/30 bg-[#7DD3C7]/45"
                  style={{ height: `${h}%` }}
                />
              </div>
            ))}
                ...
                <div key={ri} className="flex gap-0.5">
                  {row.map((val, ci) => (
                    <div
                      ...
                      style={{ height: '16px', backgroundColor: `rgba(125,211,199,${val / 12})` }}
                    />
                  ))}
                </div>
              ))}
...
export default function ShowcaseSection() {
  ...
  return (
    <section ref={sectionRef} id="Showcase" className="relative overflow-hidden py-28 md:py-36">
      <div data-sc="orb" style={{ opacity: 0 }} className="pointer-events-none absolute right-[8%] top-24 h-80 w-80 rounded-full bg-[#7DD3C7]/[0.05] blur-[110px]" />
      <div data-sc="orb" style={{ opacity: 0 }} className="pointer-events-none absolute bottom-16 left-[5%] h-72 w-72 rounded-full bg-[#D6A86A]/[0.05] blur-[100px]" />
