...
export default function TestimonialsSection() {
  return (
    <section id="Testimonials" className="relative overflow-hidden py-28 md:py-36">
      {/* Ambient */}
      <div className="pointer-events-none absolute left-[8%] top-20 h-80 w-80 rounded-full bg-[#7DD3C7]/[0.04] blur-[120px]" />
      <div className="pointer-events-none absolute right-[6%] bottom-10 h-72 w-72 rounded-full bg-[#D6A86A]/[0.04] blur-[100px]" />
