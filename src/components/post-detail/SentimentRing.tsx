export default function SentimentRing() {
  return (
    <div className="bg-[#F0EBE2] rounded-3xl p-8 border border-[#1C1814]/10 flex flex-col items-center justify-center text-center space-y-4">
      <span className="text-[10px] text-[#6A6470] uppercase tracking-widest">Audience Sentiment</span>
      ...
      <p className="text-xs text-[#6A6470] leading-relaxed px-4">
