    ...
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-xl flex items-center justify-center text-[#0F172A] font-bold text-sm shrink-0"
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <span className="text-xs text-[#64748B] uppercase tracking-[0.12em]">
      ...
      {!ok && (
        <button className="mt-3 w-full bg-[#E2E8F0] hover:bg-[#CBD5E1] text-[#0F172A] py-2 rounded-xl text-xs font-bold transition-all border border-[#0F172A]/10">
          Reconnect Account
        </button>
      )}
    </div>
