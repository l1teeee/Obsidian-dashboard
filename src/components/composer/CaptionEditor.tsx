      ...
      <div className="bg-[#1c1b1b] border border-[#4c4450]/30 rounded-2xl overflow-hidden">
        ...
        >
          <div className="overflow-hidden">
            <div className="px-3 pt-1 pb-3 space-y-3 border-t border-[#4c4450]/15">
              ...
              {hasImages && (
                <div className="flex items-center gap-2 px-2.5 py-2 rounded-xl bg-[#d394ff]/8 border border-[#d394ff]/15 mt-2">
            ...
            <div className="border-t border-[#4c4450]/15 mx-3" />
          </div>
        </div>
        ...
        <div className="px-3 py-3">
          <textarea
            ...
            className="w-full h-28 bg-[#252424] border border-[#4c4450]/20 rounded-xl p-3 text-sm text-[#e5e2e1] focus:ring-2 focus:ring-[#d394ff]/20 focus:border-[#d394ff] outline-none transition-all placeholder:text-[#988d9c]/50 resize-none leading-relaxed"
