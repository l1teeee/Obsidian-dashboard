...
export default function AIGeneratorModal({
  ...
  return createPortal(
    ...
    >
      <div
        className={`relative w-full max-w-lg bg-[#FAF7F2] rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden transition-all duration-200 ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#1C1814]/25 shrink-0">
          <div className="flex items-center gap-3">
            ...
            {screen !== 'form' && (
              <button
                ...
                className="w-8 h-8 flex items-center justify-center rounded-xl text-[#6A6470] hover:text-[#1C1814] hover:bg-white/8 transition-all disabled:opacity-30 -ml-1"
              >
                <span className="material-symbols-outlined text-[20px]">arrow_back</span>
              </button>
            )}
            <div className="w-9 h-9 rounded-xl bg-[#7DD3C7]/15 border border-[#7DD3C7]/20 flex items-center justify-center shrink-0">
              <span className="material-symbols-outlined text-[#7DD3C7]" style={{ fontSize: 18, fontVariationSettings: "'FILL' 1" }}>
                {screen === 'edit-preview' ? 'edit' : 'auto_awesome'}
              </span>
            </div>
            <div>
              <h2 className="text-sm font-bold text-[#1C1814] leading-none mb-0.5">
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-xl text-[#6A6470] hover:text-[#1C1814] hover:bg-white/8 transition-all disabled:opacity-30"
          >
        ...
        {screen === 'form' && (
          <>
            ...
            <div className="px-5 pt-4 shrink-0">
              <div className="flex gap-1 p-1 bg-[#252424] rounded-xl border border-[#1C1814]/20">
                {(['single', 'carousel'] as const).map(mode => (
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-[10px] text-[11px] font-bold uppercase tracking-wider transition-all disabled:opacity-50 ${
                      genMode === mode ? 'bg-[#7DD3C7]/20 text-[#7DD3C7]' : 'text-[#6A6470] hover:text-[#5C5650]'
                    }`}
                  >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4 min-h-0">
              ...
              {genMode === 'single' && (
                <>
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Describe your image</label>
                    <textarea
                      value={prompt}
                      rows={3}
                      ...
                      disabled={genLoading}
                      className="w-full bg-[#252424] border border-[#1C1814]/30 rounded-xl px-4 py-3 text-sm text-[#1C1814] placeholder:text-[#6A6470]/40 outline-none focus:border-[#7DD3C7]/50 transition-colors resize-none disabled:opacity-50 leading-relaxed"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Aspect ratio</label>
                        ...
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all disabled:opacity-50 ${
                            size === opt.value
                              ...
                              : 'bg-[#252424] text-[#6A6470] border border-[#1C1814]/20 hover:border-[#7DD3C7]/20 hover:text-[#5C5650]'
                          }`}
                        >
              ...
              {genMode === 'carousel' && (
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Topic</label>
                    <input
                      type="text"
                      value={carouselTopic}
                      ...
                      disabled={genLoading}
                      className="w-full bg-[#252424] border border-[#1C1814]/30 rounded-xl px-4 py-3 text-sm text-[#1C1814] placeholder:text-[#6A6470]/40 outline-none focus:border-[#7DD3C7]/50 transition-colors disabled:opacity-50"
                    />
                  </div>

                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Visual style</label>
                    <div className="flex flex-wrap gap-1.5">
                        ...
                        <button
                          ...
                          className={`flex items-center gap-1 px-3 py-1.5 rounded-lg text-[10px] font-semibold transition-all disabled:opacity-50 ${
                            carouselStyle === p.value
                              ? 'bg-[#7c3aed] text-[#1C1814] shadow-sm'
                              : 'bg-[#252424] text-[#6A6470] border border-[#1C1814]/20 hover:border-[#7DD3C7]/20 hover:text-[#5C5650]'
                          }`}
                        >
                      ...
                      <button
                        ...
                        className={`w-8 h-[34px] rounded-lg text-sm font-bold transition-all disabled:opacity-50 ${
                          showCustomStyle ? 'bg-[#7DD3C7]/20 text-[#7DD3C7] border border-[#7DD3C7]/35' : 'bg-[#252424] text-[#6A6470] border border-[#1C1814]/20 hover:border-[#7DD3C7]/20 hover:text-[#5C5650]'
                        }`}
                      >+</button>
                    </div>
                    {showCustomStyle && (
                      <input type="text" value={carouselStyle} onChange={e => setCarouselStyle(e.target.value)} placeholder="Describe your own visual style…" autoFocus disabled={genLoading}
                        className="w-full bg-[#252424] border border-[#1C1814]/30 rounded-xl px-3 py-2.5 text-[11px] text-[#1C1814] placeholder:text-[#6A6470]/40 outline-none focus:border-[#7DD3C7]/50 transition-colors disabled:opacity-50"
                      />
                    )}
                  </div>

                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Slides</label>
                    <div className="flex items-center gap-2">
                        ...
                        {[2, 3, 4, 5, 6].map(n => (
                          <button key={n} onClick={() => { setCarouselCount(n); setCarouselSlides([]); }} disabled={genLoading}
                            className={`w-9 h-9 rounded-xl text-[12px] font-bold transition-all disabled:opacity-50 ${
                              carouselCount === n ? 'bg-[#7DD3C7]/25 text-[#7DD3C7] border border-[#7DD3C7]/40' : 'bg-[#252424] text-[#6A6470] border border-[#1C1814]/20 hover:border-[#7DD3C7]/20 hover:text-[#5C5650]'
                            }`}
                          >{n}</button>
                        ))}
                      </div>
                      <button
                        ...
                        className="ml-auto flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#252424] border border-[#7DD3C7]/25 text-[#7DD3C7] text-[10px] font-bold uppercase tracking-wider disabled:opacity-40 hover:bg-[#7DD3C7]/10 hover:border-[#7DD3C7]/40 transition-all active:scale-[0.98]"
                      >
                  ...
                  {carouselSlides.length > 0 ? (
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between px-0.5">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Prompts — click to edit</label>
                        <span className="text-[9px] text-[#6A6470]/50">{carouselSlides.length} slides</span>
                      </div>
                      {carouselSlides.map((slide, i) => (
                        <div key={i} className="rounded-xl border border-[#1C1814]/25 bg-[#252424] overflow-hidden">
                          <button type="button" onClick={() => toggleSlide(i)} className="w-full flex items-center gap-2 px-3 py-2.5 text-left hover:bg-[#2a2929] transition-colors">
                            <span className="text-[10px] font-bold text-[#7DD3C7]/60 w-5 shrink-0 text-right">{i + 1}</span>
                            <span className="flex-1 text-[11px] text-[#5C5650] truncate">{getSlideTitle(slide) || `Slide ${i + 1}`}</span>
                            <span className="material-symbols-outlined text-[#6A6470]/40 text-[16px] shrink-0 transition-transform duration-200" style={{ transform: expandedSlides.has(i) ? 'rotate(180deg)' : '' }}>expand_more</span>
                          </button>
                          <div className="overflow-hidden transition-all duration-200 ease-out" style={{ maxHeight: expandedSlides.has(i) ? '160px' : '0px' }}>
                            <div className="px-3 pb-3">
                              <textarea value={slide} rows={1}
                                ...
                                className="w-full bg-[#1e1e1e] border border-[#1C1814]/30 rounded-xl px-3 py-2 text-[11px] text-[#1C1814] outline-none focus:border-[#7DD3C7]/50 transition-colors resize-none leading-relaxed overflow-hidden"
                              />
                            </div>
                          </div>
                        </div>
                    ...
                    !slidesLoading && !slidesError && (
                      <div className="flex flex-col items-center gap-2 py-4 rounded-xl border border-dashed border-[#1C1814]/30">
                        <span className="material-symbols-outlined text-[#6A6470]/30 text-[28px]">auto_stories</span>
                        <p className="text-[11px] text-[#6A6470]/50 text-center px-4">Enter a topic and click <span className="text-[#7DD3C7]/70">Generate prompts</span></p>
                      </div>
                    )
                  )}
                </div>
            ...
            {/* Footer */}
            <div className="px-5 py-4 border-t border-[#1C1814]/25 shrink-0 space-y-2.5">
              {genLoading && (
                <div className="flex items-center justify-center gap-2 py-1">
                  <span className="material-symbols-outlined text-[#7DD3C7] text-[15px] animate-spin">progress_activity</span>
                  <span className="text-[11px] text-[#7DD3C7]/80 font-medium">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#7DD3C7] text-[#5e2388] text-sm font-bold uppercase tracking-wider hover:brightness-110 transition-all active:scale-[0.99] disabled:opacity-40 disabled:cursor-not-allowed"
              >
              ...
              {availableSlots === 0 && <p className="text-center text-[10px] text-[#6A6470]/60">Maximum media reached (10/10)</p>}
            </div>
          </>
        )}
          ...
          <>
            <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4 min-h-0">
              ...
              <div className="relative flex items-center justify-center py-4">
                <div className="absolute inset-0 rounded-2xl bg-[#7DD3C7]/5" />
                <img
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-full backdrop-blur-md text-[10px] font-semibold transition-all border shadow-lg ${
                        showPromptTip
                          ? 'bg-[#7DD3C7]/30 border-[#7DD3C7]/50 text-[#1C1814]'
                          : 'bg-black/50 border-white/15 text-[#1C1814]/70 hover:bg-black/70 hover:text-[#1C1814]'
                      }`}
                    >
                    ...
                    {showPromptTip && (
                      <div className="absolute bottom-full left-0 mb-2 z-20 w-72">
                        <div className="bg-[#E5DFD6] border border-[#1C1814]/40 rounded-xl p-3 shadow-xl">
                          <p className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/60 mb-1.5">
                            {generatedResult.revisedPrompt ? 'Auto-optimized prompt' : 'Prompt used'}
                          </p>
                          <p className="text-[11px] text-[#1C1814] italic leading-relaxed mb-2.5">
                            "{generatedResult.revisedPrompt ?? generatedResult.originalPrompt}"
                          </p>
                          <div className="border-t border-[#1C1814]/20 pt-2">
                            <button
                              onClick={() => copyPrompt(generatedResult.revisedPrompt ?? generatedResult.originalPrompt)}
                              className="flex items-center gap-1.5 text-[9px] font-semibold text-[#6A6470] hover:text-[#7DD3C7] transition-colors"
                            >
                        ...
                        <div className="flex ml-3">
                          <div className="w-2.5 h-2.5 bg-[#E5DFD6] border-b border-r border-[#1C1814]/40 rotate-45 -mt-1.5" />
                        </div>
                      </div>
                    )}
                  </div>
              ...
              {/* Divider */}
              <div className="flex items-center gap-3">
                <div className="flex-1 h-px bg-[#1C1814]/20" />
                <span className="text-[10px] text-[#6A6470]/50 uppercase tracking-widest">What next?</span>
                <div className="flex-1 h-px bg-[#1C1814]/20" />
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[#1C1814]">Edit with AI</p>
                    <p className="text-[10px] text-[#6A6470] mt-0.5">Modify specific elements — change colors, style, objects</p>
                  </div>
                  <span className="material-symbols-outlined text-[#6A6470]/40 group-hover:text-[#ffd166]/60 transition-colors text-[18px]">chevron_right</span>
                </button>

                {/* Try another */}
                <button
                  onClick={goBackToForm}
                  className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl bg-[#252424] border border-[#1C1814]/20 hover:border-[#1C1814]/40 hover:bg-[#2a2929] transition-all group text-left"
                >
                  <div className="w-9 h-9 rounded-xl bg-[#988d9c]/10 flex items-center justify-center shrink-0 group-hover:bg-[#988d9c]/20 transition-colors">
                    <span className="material-symbols-outlined text-[#6A6470]" style={{ fontSize: 18 }}>refresh</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[#5C5650]">Generate another</p>
                    <p className="text-[10px] text-[#6A6470] mt-0.5">Go back and try a different prompt or style</p>
                  </div>
                  <span className="material-symbols-outlined text-[#6A6470]/40 group-hover:text-[#6A6470]/70 transition-colors text-[18px]">chevron_right</span>
                </button>
              </div>
            </div>

            {/* Footer */}
            <div className="px-5 py-4 border-t border-[#1C1814]/25 shrink-0">
              <button
                onClick={handleUseImage}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#7DD3C7] text-[#5e2388] text-sm font-bold uppercase tracking-wider hover:brightness-110 transition-all active:scale-[0.99]"
              >
        ...
        {screen === 'edit-preview' && generatedResult && (
          <>
            <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4 min-h-0">
              ...
              {/* Edit instruction */}
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase tracking-widest text-[#6A6470]/70">Instruction</label>
                <input
                  type="text"
                  value={editPrompt}
                  ...
                  disabled={editLoading}
                  autoFocus
                  className="w-full bg-[#252424] border border-[#1C1814]/30 rounded-xl px-4 py-3 text-sm text-[#1C1814] placeholder:text-[#6A6470]/40 outline-none focus:border-[#ffd166]/40 transition-colors disabled:opacity-50"
                />
              </div>
            ...
            <div className="px-5 py-4 border-t border-[#1C1814]/25 shrink-0 space-y-2">
              ...
              <button
                ...
                disabled={editLoading}
                className="w-full flex items-center justify-center gap-1.5 py-2 rounded-xl text-[11px] text-[#6A6470] hover:text-[#1C1814] hover:bg-white/5 transition-all disabled:opacity-40"
              >
                Use image as-is
              </button>
            </div>
