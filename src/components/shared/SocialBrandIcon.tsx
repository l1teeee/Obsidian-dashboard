...
export default function SocialBrandIcon({ platformId, size = 28, color = 'white' }: SocialBrandIconProps) {
  const s = size;
  ...
  switch (platformId) {
    ...
    case 'threads':
      return <SiThreads size={s} color={color} aria-hidden="true" />;

    case 'bluesky':
      return <SiBluesky size={s} color={color} aria-hidden="true" />;
